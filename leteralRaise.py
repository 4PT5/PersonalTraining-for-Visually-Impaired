...
def setting(exCode):
    ...
    print("왼 손목-어깨 기울기: " + str(up_left_slope_LIMIT))
    print("오 손목-어깨 기울기: " + str(up_right_slope_LIMIT))
    ...
    print("왼 손목-어깨 기울기: " + str(down_left_slope_LIMIT))
    print("오 손목-어깨 기울기: " + str(down_right_slope_LIMIT))
...
def raiseDown(keypoint):
    ...
    print("down 왼 기울기: " + str(left_slope))
    print("down dh 기울기: " + str(right_slope))
...
def raiseUp(keypoint):
    ...
    print("up 왼 기울기: " + str(left_slope))
    print("up 오 기울기: " + str(right_slope))
    value = 20
